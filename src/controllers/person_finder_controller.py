...
class PersonFinderController:
    ...
    def find(self,person_id: int) -> Dict: #type: ignore
    ...
    def __find_person_in_db(self, person_id: int) -> PeopleTable: #type: ignore
    ...
    def __format_response(self, person: PeopleTable) -> Dict: # type: ignore
        return{
            "data":{
                "type": "Person",
                "count": 1,
